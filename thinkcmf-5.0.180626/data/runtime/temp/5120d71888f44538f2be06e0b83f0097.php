<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"themes/admin_simpleboot3/admin\teacher\add.html";i:1534057194;s:93:"E:\php\PHPTutorial\WWW\thinkcmf-5.0.180626\public\themes\admin_simpleboot3\public\header.html";i:1529914518;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    ...
    <form method="post" class="form-horizontal js-ajax-form margin-top-20" action="<?php echo url('teacher/addPost'); ?>">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-10">
                <input type="text" class="form-control" name="cid_list" value="">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label"><span class="form-required">*</span>性别（男1/女2）:</label>
            <select class="btn btn-primary dropdown-toggle" name="gender" value="" style="margin-left:15px;width: 100px;text-align: center">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-10">
                <textarea class="form-control" name="resume" rows="5" cols="57"></textarea>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-10">
                <input type="text" class="form-control" name="idea" value="">
            </div>
        </div>
