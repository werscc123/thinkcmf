<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"themes/admin_simpleboot3/admin\recruit\add.html";i:1534066042;s:93:"E:\php\PHPTutorial\WWW\thinkcmf-5.0.180626\public\themes\admin_simpleboot3\public\header.html";i:1529914518;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="<?php echo url('recruit/add'); ?>"><?php echo lang('ADMIN_RECRUIT_ADD'); ?></a></li>
        <!--<li><a  href="<?php echo url('nav/edit'); ?>" ><?php echo lang('ADMIN_NAV_EDIT'); ?></a></li>-->
    </ul>
    <form method="post" class="form-horizontal js-ajax-form margin-top-20" action="<?php echo url('recruit/addPost'); ?>">
        ...
        <label class="col-sm-2 control-label"><span class="form-required">*</span>要求:</label>
            <div class="col-md-6 col-sm-10">
                <input type="text" class="form-control" name="require" value="">
            </div>
        </div>
