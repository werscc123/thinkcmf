<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"themes/admin_simpleboot3/admin\feedback\edit.html";i:1533994328;s:93:"E:\php\PHPTutorial\WWW\thinkcmf-5.0.180626\public\themes\admin_simpleboot3\public\header.html";i:1529914518;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap">
    <ul class="nav nav-tabs">
        <li><a href="<?php echo url('feedback/index'); ?>"><?php echo lang('ADMIN_FEEDBACK_INDEX'); ?></a></li>
        <li><a href="<?php echo url('feedback/add'); ?>"><?php echo lang('ADMIN_FEEDBACK_ADD'); ?></a></li>
        <li class="active" ><a><?php echo lang('ADMIN_FEEDBACK_EDIT'); ?></a></li>
    </ul>
    <form method="post" class="form-horizontal js-ajax-form margin-top-20" action="<?php echo url('feedback/editPost'); ?>">
        ...
        <div class="form-group">
            ...
            <select class="btn btn-primary dropdown-toggle" name="type" value="<?php echo $type; ?>" style="margin-left:15px;width: 100px;text-align: center">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-10">
                <textarea class="form-control" name="content" rows="5" cols="57"><?php echo $content; ?></textarea>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="col-sm-offset-2 col-sm-10">
            ...
            <a class="btn btn-default" href="<?php echo url('feedback/index'); ?>">返回</a>
        </div>
    </form>
