...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li class="active"><a href="<?php echo url('course/index'); ?>"><?php echo lang('ADMIN_COURSE_INDEX'); ?></a></li>
        <li><a href="<?php echo url('course/add'); ?>"><?php echo lang('ADMIN_COURSE_ADD'); ?></a></li>
    </ul>
    <form class="well form-inline margin-top-20" method="post" action="<?php echo url('course/search'); ?>">
        课程名称:
        <input type="text" class="form-control" name="course_name" style="width: 130px;" value="<?php echo $course_name; ?>" placeholder="请输入<?php echo lang('COURSE_NAME'); ?>">
        教师名称:
        <input type="text" class="form-control" name="teacher_name" style="width: 130px;" value="<?php echo $teacher_name; ?>" placeholder="请输入<?php echo lang('TEACHER_NAME'); ?>">
        课程等级：
            ...
            <?php if(is_array($courses) || $courses instanceof \think\Collection || $courses instanceof \think\Paginator): if( count($courses)==0 ) : echo "" ;else: foreach($courses as $key=>$vo): ?>
                <tr>
                    ...
                    <td width="140">
                        ...
                        <a class="js-ajax-delete" href="<?php echo url('course/delete',array('id'=>$vo['id'])); ?>"><?php echo lang('DELETE'); ?></a>
                    </td>
                </tr>
